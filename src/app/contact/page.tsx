 ...
 *
 * Deliberately not a contact form. Every enquiry route on this site is a
 ...
 * enquiries on WhatsApp anyway. It also means the site collects no personal
 * data at all, which is what makes the privacy policy honest and short.
 */
    ...
    <div className="flex flex-1 flex-col">
      ...
      <main className="flex flex-1 flex-col">
        <PageHero
          ...
          actions={
            <ButtonLink href={whatsAppUrl(chatMessage)}>
